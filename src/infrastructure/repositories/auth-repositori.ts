...
import { usersTwoRepository } from "./users-repository"
import { randomUUID } from "crypto"
import { add } from "date-fns"
import { emailAdapter } from "../adapters/email-adapter"
import { CreateUserModel, UserType, UsersModel } from "../../models/users-model"
...
export class AuthRepository {
    ...
    async confirmEmail(code: string): Promise<boolean> {
        ...
        //if(user.canBeConfirmed(code)) {
            //confirm(code)
           // ler result = await usersRepository.updateConfirmation(user._id)
            //return result
        //}
