...
import { CommentModel, NewestLikeTypePost, PostModel } from "../../db/db"
import { TPagination } from "../../hellpers/pagination"
import { PaginatedPost, PostViewModel2, PostsDBModels} from "../../models/posts-model"
import { CommentDB, PaginatedCommentViewModel, commentViewModel, commentViewType } from "../../models/comment-models"
import { randomUUID } from "crypto"
 ...
 export class PostsQueryRepository {
   ...
   async updatePostLikeStatus(existingPost: PostsDBModels, latestLikes: NewestLikeTypePost[]){
    ...
    try {
       ...
       'extendedLikesInfo.statuses': existingPost.extendedLikesInfo.statuses,
